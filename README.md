...
| `Mask2D` | Draw one rectangle, square, or circle and use its Boolean mask directly in Python | [tutorial](https://electronmicroscopy.github.io/quantem.widget/tutorials/show2d.html#turn-a-drawn-region-into-a-boolean-mask) · [API](https://electronmicroscopy.github.io/quantem.widget/api/mask2d.html) |
