...
| --- | --- | --- |
| Small Python, docs, or protocol change | `scripts/widget_local_signoff.sh --quick` | Size guards, frontend build, focused tests, HTML export smoke report. |
| Normal widget change before saying it is ready | `scripts/widget_local_signoff.sh` | Full tests, HTML export smoke report, docs build. |
...
The top-level `index.html` links to the generated reports. The normal HTML
smoke report contains:
...
default CI gate should stay lightweight. Browser-heavy, mobile, physical phone,
